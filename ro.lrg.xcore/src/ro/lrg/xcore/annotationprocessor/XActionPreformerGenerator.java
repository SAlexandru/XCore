...
import ro.lrg.xcore.metametamodel.HList;
import ro.lrg.xcore.metametamodel.HListEmpty;
import ro.lrg.xcore.metametamodel.IActionPerformer;
import ro.lrg.xcore.metametamodel.ThisIsAnAction;
...
public class XActionPreformerGenerator {
	...
	public String generateSignature() {
		...
		return doc + String.format("\t@" + ThisIsAnAction.class.getCanonicalName() 
		    + "(numParams = %d) \n\tpublic %s %s (%s);\n\n", argumentTypes_.size(), 
	...
	public String generateImpl(String instanceName) {
		...
		builder.append("new " + HList.class.getCanonicalName() + "<>(");
		...
		if (argumentTypes_.isEmpty()) {
			return doc + String.format(
					"\t@" +ThisIsAnAction.class.getCanonicalName() 
		...
		return doc + String.format(
				"\t@" + ThisIsAnAction.class.getCanonicalName() + "(numParams = %d)"
