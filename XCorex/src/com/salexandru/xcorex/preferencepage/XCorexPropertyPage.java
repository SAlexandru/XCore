package com.salexandru.xcorex.preferencepage;
...
import com.salexandru.xcorex.plugin.Activator;

@SuppressWarnings("restriction")
public class XCorexPropertyPage extends PropertyPage implements IWorkbenchPreferencePage {
	@Override
	protected Control createContents(Composite parent) {
		...
		new XCorexFieldEditor(jProject, corex);
